...
namespace Win32.Common.Providers.Settings
{
    ...
    ///     
    /// </summary>
    public class SettingsDbProvider<TSetting> : ISettingsProvider<TSetting, SettingsDbConfig>, ISettingsDbProvider
        where TSetting : class, ISettings, new()
    {
        private readonly ILogger<SettingsDbProvider<TSetting>> _logger;

        /// <summary>
        ///     Initializes a new instance of the <see cref="SettingsDbProvider{TSetting}"/> class.
        /// </summary>
        /// <param name="logger">An instance of <see cref="ILogger{SettingsDbProvider}"/>.</param>
        public SettingsDbProvider(ILogger<SettingsDbProvider<TSetting>> logger)
        {
            if (_logger is null)
        ...
        public void Initialize(SettingsDbConfig registryConfig)
        {
    ...
    /// </summary>
    public class SettingsDbConfig : ISettingsProviderConfig
    {
        /// <summary>
