namespace Win32.Common
{
    ...
    internal partial class Unmanaged
    {
        ...
        public partial class User32
        {
            ...
            {
                /// <summary>
                ///     Indicates how a uPosition parameter is interpreted. 
                /// </summary>
                public enum MY_BY : long
                {
                    /// <summary>
                ...
                public enum ShowWindowCommands : uint
                {
                    ...
                    SW_MINIMIZE = 6,
                    /// <summary>
                    ///     Displays the window as a minimized window. This value is similar to <see cref="ShowWindowCommands.SW_SHOWMINIMIZED"/>, except
                    ///     the window is not activated.
                    /// </summary>
                    SW_SHOWMINNOACTIVE = 7,
                    /// <summary>
                    ///     Displays the window in its current size and position. This value is similar to <see cref="ShowWindowCommands.SW_SHOW"/>,
                    ...
                    SW_RESTORE = 9,
                    /// <summary>
                    ///     Items 10, 11 and 11 existed in the VB definition but not the c# definition - so I am assuming this was a mistake and have
                    ///     added them here. Please forgive me if this is wrong! I don't think it should have any negative impact. According to what I
                    ///     have read elsewhere: The SW_SHOWDEFAULT makes sure the window is restored prior to showing, then activating. And the 11's try
                    ///     to coerce a window to minimized or maximized.
                    /// </summary>
                    SW_SHOWDEFAULT = 10,
                    /// <summary>
                ...
                /// <summary>
                ///     Color index used to get a system color from <c>GetSysColor</c>.
                /// </summary>
                ...
                /// <summary>
                ///     The system metric or configuration setting to be retrieved by <see cref="GetSystemMetrics(SystemMetric)"/>.
                /// </summary>
                public enum SystemMetric : uint
                {
                    ...
                    SM_ARRANGE = 56,
                    /// <summary>
                    ///     The value that specifies how the system is started: 0 Normal boot 1 Fail-safe boot 2 Fail-safe with network boot A fail-safe
                    ///     boot (also called SafeBoot, Safe Mode, or Clean Boot) bypasses the user startup files.
                    /// </summary>
                    SM_CLEANBOOT = 67,
                    /// <summary>
                    ...
                    ///     is negative, it is subtracted from the left of the mouse-down point and added to the right of it.
                    /// </summary>
                    SM_CXDRAG = 68,
                    /// <summary>
                    ...
                    ///     is the height of the horizontal border, and SM_CYFIXEDFRAME is the width of the vertical border. This value is the same as SM_CXDLGFRAME.
                    /// </summary>
                    SM_CXFIXEDFRAME = 7,
                    /// <summary>
                    ///     The width of the left and right edges of the focus rectangle that the DrawFocusRectdraws. This value is in pixels. Windows
                    ...
                    ///     SystemParametersInfofunction with the SPI_GETWORKAREA value.
                    /// </summary>
                    SM_CXFULLSCREEN = 16,
                    /// <summary>
                    ...
                    ///     width of the horizontal border, and SM_CYSIZEFRAME is the height of the vertical border. This value is the same as SM_CXFRAME.
                    /// </summary>
                    SM_CXSIZEFRAME = 32,
                    /// <summary>
                    ...
                    ///     double-click. The two clicks must also occur within a specified time. To set the height of the double-click rectangle, call
                    ...
                    /// <summary>
                    ///     The thickness of the frame around the perimeter of a window that has a caption but is not sizable, in pixels. SM_CXFIXEDFRAME
                    ///     is the height of the horizontal border, and SM_CYFIXEDFRAME is the width of the vertical border. This value is the same as SM_CYDLGFRAME.
                    /// </summary>
                    SM_CYFIXEDFRAME = 8,
                    /// <summary>
                    ///     The height of the top and bottom edges of the focus rectangle drawn byDrawFocusRect. This value is in pixels. Windows 2000:
                    ...
                    ///     the portion of the screen not obscured by the system taskbar or by application desktop toolbars, call the SystemParametersInfo
                    ...
                    /// <summary>
                    ///     The thickness of the sizing border around the perimeter of a window that can be resized, in pixels. SM_CXSIZEFRAME is the
                    ///     width of the horizontal border, and SM_CYSIZEFRAME is the height of the vertical border. This value is the same as SM_CYFRAME.
                    /// </summary>
                    SM_CYSIZEFRAME = 33,
                    /// <summary>
                    ...
                    ///     number of contacts supported by every digitizer in the system. If the system has only single-touch digitizers, the return
                    ///     value is 1. If the system has multi-touch digitizers, the return value is the number of simultaneous contacts the hardware can
                    ...
                    ///     the return value is 0. Windows Server 2003 and Windows XP: The console session is not necessarily the physical console. For
                    ///     more information, seeWTSGetActiveConsoleSessionId.
                    /// </summary>
