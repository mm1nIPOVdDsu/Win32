...
namespace Win32.Common
{
    ...
    {
        /// <summary>
        ///     Aligns a number to the neighboring multiple.
        /// </summary>
        /// <param name="value">The value to align.</param>
        /// <param name="pow2">A number that is a power of 2 (e.g. 2, 4, 8, 16, ...).</param>
        /// <returns>A value that is aligned to the next multiple of <paramref name="pow2"/>. This value may be the same as <paramref name="value"/>.</returns>
        ...
        /// <summary>
        ///     Retrieves the signed x-coordinate from the specified <c>LPARAM</c> value.
        /// </summary>
        /// <param name="lp">The value to be converted.</param>
        /// <returns>The signed x-coordinate.</returns>
        // https://docs.microsoft.com/en-us/windows/win32/api/windowsx/nf-windowsx-get_x_lparam void GET_X_LPARAM( lp );
        public static int GET_X_LPARAM(IntPtr lp) => unchecked((short)(long)lp);
        /// <summary>
        ///     Retrieves the signed y-coordinate from the given <c>LPARAM</c> value.
        /// </summary>
        /// <param name="lp">The value to be converted.</param>
        /// <returns>The signed y-coordinate.</returns>
        // https://docs.microsoft.com/en-us/windows/win32/api/windowsx/nf-windowsx-get_y_lparam void GET_Y_LPARAM( lp );
        ...
        /// <summary>
        ///     Gets the high 8-bytes from a <see cref="long"/> value.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the lower 8-bytes from a <see cref="long"/> value.
        /// </summary>
        /// <param name="lValue">The <see cref="long"/> value.</param>
        ...
        /// <summary>
        ///     Converts the specified atom into a pointer, so it can be passed to functions which accept either atoms or strings.
        /// </summary>
        ...
        /// <remarks>
        ///     Although the return value of the <c>MAKEINTATOM</c> macro is cast as an <c>LPTSTR</c> value, it cannot be used as a string pointer
        ///     except when it is passed to atom-management functions that require an <c>LPTSTR</c> argument.
        /// </remarks>
        // https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-makeintatom void MAKEINTATOM( i );
        ...
        /// <summary>
        ///     Retrieves the high-order 16-bit value from the specified 32-bit value.
        /// </summary>
        ...
        /// <summary>
        ///     Retrieves the low-order 16-bit value from the specified 32-bit value.
        /// </summary>
        /// <param name="iValue">The value to be converted.</param>
