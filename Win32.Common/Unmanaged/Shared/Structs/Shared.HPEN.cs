...
namespace Win32.Common
{
    ...
    internal partial class Unmanaged
    {
        ...
        {
            /// <summary>
            ///     Provides a handle to a drawing pen.
            /// </summary>
            ...
            public struct HPEN : IGraphicsObjectHandle
            {
                ...
                /// <summary>
                ///     Initializes a new instance of the <see cref="HPEN"/> struct.
                /// </summary>
                /// <param name="preexistingHandle">An <see cref="IntPtr"/> object that represents the pre-existing handle to use.</param>
                public HPEN(IntPtr preexistingHandle) => handle = preexistingHandle;

                /// <summary>
                ///     Returns an invalid handle by instantiating a <see cref="HPEN"/> object with <see cref="IntPtr.Zero"/>.
                /// </summary>
                ...
                /// <summary>
                ///     Performs an explicit conversion from <see cref="HPEN"/> to <see cref="IntPtr"/>.
                /// </summary>
                ...
                /// <summary>
                ///     Performs an implicit conversion from <see cref="IntPtr"/> to <see cref="HPEN"/>.
                /// </summary>
                ...
                /// <summary>
                ///     Performs an implicit conversion from <see cref="HGDIOBJ"/> to <see cref="HPEN"/>.
                /// </summary>
