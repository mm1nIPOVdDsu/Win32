    ...
    internal partial class Unmanaged
    {
        ...
        public partial class Shared
        {
            ...
            public struct HBITMAP : IGraphicsObjectHandle
            {
                ...
                /// <summary>
                ///     Initializes a new instance of the <see cref="HBITMAP"/> struct.
                /// </summary>
                /// <param name="preexistingHandle">An <see cref="IntPtr"/> object that represents the pre-existing handle to use.</param>
                public HBITMAP(IntPtr preexistingHandle) => handle = preexistingHandle;

                /// <summary>
                ///     Returns an invalid handle by instantiating a <see cref="HBITMAP"/> object with <see cref="IntPtr.Zero"/>.
                /// </summary>
                ...
                /// <summary>
                ///     Performs an explicit conversion from <see cref="HBITMAP"/> to <see cref="IntPtr"/>.
                /// </summary>
                ...
                /// <summary>
                ///     Performs an implicit conversion from <see cref="IntPtr"/> to <see cref="HBITMAP"/>.
                /// </summary>
                ...
                /// <summary>
                ///     Performs an implicit conversion from <see cref="HGDIOBJ"/> to <see cref="HBITMAP"/>.
                /// </summary>
